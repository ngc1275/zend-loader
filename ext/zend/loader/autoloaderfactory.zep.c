...
ZEPHIR_INIT_CLASS(Zend_Loader_AutoloaderFactory) {
	...
	ZEPHIR_REGISTER_CLASS(Zend\\Loader, AutoloaderFactory, zend_loader, autoloaderfactory, zend_loader_autoloaderfactory_method_entry, ZEND_ACC_EXPLICIT_ABSTRACT_CLASS);
